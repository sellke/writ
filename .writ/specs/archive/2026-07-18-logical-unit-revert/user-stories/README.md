...
|-------|-------|--------|-------|----------|------------|
| 1 | [Record story commit SHA](./story-1-record-story-sha.md) | Complete | 4/4 | High | — |
| 2 | [Commit resolver (`revert-resolve.py`)](./story-2-commit-resolver.md) | Complete | 7/7 | High | Story 1 |
| 3 | [`/revert` command](./story-3-revert-command.md) | Complete | 6/6 | High | Story 2 |
| 4 | [Artifact restoration + eval](./story-4-artifact-restoration-eval.md) | Complete | 5/5 | Medium | Story 3 |

**Overall:** 22/22 tasks · 100%
