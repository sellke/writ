...
| 3 | [Cut Behavior Requests — Line-by-Line Classification to a 10,000-Byte Base, Batching Line to Adapters](story-3-cut-behavior-requests.md) | Completed ✅ (2026-09-07) | High | 2 | 5 | 7 | 7/7 |
...
| 5 | [Baseline Re-run and Keep-or-Revert — Eight Fable 5.1 Runs on the Pruned Base, Compared Against Stage 1](story-5-baseline-rerun-keep-or-revert.md) | Completed ✅ (2026-09-08) | High | 3, 4 | 4 | 6 | 6/6 |

**Total:** 5 stories · 24 acceptance criteria · 33 tasks · 33/33 complete (100%)
