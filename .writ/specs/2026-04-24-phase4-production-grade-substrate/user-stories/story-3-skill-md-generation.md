...
- [x] 3.1 Write a verification checklist covering all 6 acceptance criteria; commit as `.writ/specs/.../user-stories/verification/story-3.md`
...
- Added `user-stories/verification/story-3.md` with acceptance-criteria evidence, including deliberate drift and malformed-manifest simulations.
