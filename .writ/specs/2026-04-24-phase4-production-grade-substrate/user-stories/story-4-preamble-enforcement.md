...
- [x] 4.1 Write a verification checklist covering all 5 acceptance criteria; commit as `.writ/specs/.../user-stories/verification/story-4.md`
...
- `.writ/specs/2026-04-24-phase4-production-grade-substrate/user-stories/verification/story-4.md` — verification checklist and results for Story 4.
