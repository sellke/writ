...
- [x] 2.1 Write a verification checklist covering all 5 acceptance criteria; save as `.writ/specs/.../user-stories/story-2-verification.md` (not git-committed per user instruction)
...
- `user-stories/story-2-verification.md` — Added a manual verification checklist covering all five acceptance criteria.
