...
| 2026-09-07 | commands/_preamble.md | behavior-request | Authoring rule for command writers, not a session fact; adapters/*.md map the generic tool names by design (ADR-001) | ## Adapter Neutrality |
| 2026-09-07 | commands/_preamble.md | behavior-request | Authoring rule for command writers, not a session fact; adapters/*.md map the generic tool names by design (ADR-001) | Commands must work identically on Cursor, Claude Code, and OpenClaw through the |
| 2026-09-07 | commands/_preamble.md | behavior-request | Authoring rule for command writers, not a session fact; adapters/*.md map the generic tool names by design (ADR-001) | generic tool-name vocabulary. Do not require platform-specific runtime hooks. |
| 2026-09-07 | commands/_preamble.md | behavior-request | Model-specific batching nudge (research F1); one Fable 5.1 line per adapters/*.md under ## Model-specific | - **Parallel tool calls** - independent reads, searches, or checks |
| 2026-09-07 | commands/_preamble.md | duplicate | adapters/*.md tool-mapping tables (todo_write); commands that track progress name it | - **todo_write** - multi-step task tracking |
| 2026-09-07 | commands/_preamble.md | duplicate | system-instructions.md ## Interaction Tool Selection (the AskQuestion / Plan Mode rule) | ## Tool Selection |
| 2026-09-07 | commands/_preamble.md | duplicate | system-instructions.md ## Interaction Tool Selection (the AskQuestion / Plan Mode rule) | - **AskQuestion** - bounded decisions with enumerable options |
| 2026-09-07 | commands/_preamble.md | duplicate | system-instructions.md ## Interaction Tool Selection (the AskQuestion / Plan Mode rule) | - **Plan Mode** - open-ended discovery and shaping |
| 2026-09-07 | system-instructions.md | duplicate | commands/_preamble.md ## File Organization (the surviving tree); explanations/ is used by no command | ## File Organization |
| 2026-09-07 | system-instructions.md | duplicate | commands/_preamble.md ## File Organization (the surviving tree); explanations/ is used by no command | ``` |
| 2026-09-07 | system-instructions.md | duplicate | commands/_preamble.md ## File Organization (the surviving tree); explanations/ is used by no command | .writ/ |
| 2026-09-07 | system-instructions.md | duplicate | commands/_preamble.md ## File Organization (the surviving tree); explanations/ is used by no command | ├── specs/            # Requirements, specifications, and tasks |
| 2026-09-07 | system-instructions.md | duplicate | commands/_preamble.md ## File Organization (the surviving tree); explanations/ is used by no command | ├── product/          # Product roadmap, strategy, and planning |
| 2026-09-07 | system-instructions.md | duplicate | commands/_preamble.md ## File Organization (the surviving tree); explanations/ is used by no command | ├── research/         # Technical research and analysis |
| 2026-09-07 | system-instructions.md | duplicate | commands/_preamble.md ## File Organization (the surviving tree); explanations/ is used by no command | ├── decision-records/ # Architecture Decision Records |
| 2026-09-07 | system-instructions.md | duplicate | commands/_preamble.md ## File Organization (the surviving tree); explanations/ is used by no command | ├── docs/             # Generated documentation, best practices |
| 2026-09-07 | system-instructions.md | duplicate | commands/_preamble.md ## File Organization (the surviving tree); explanations/ is used by no command | ├── issues/           # Issue tracking and triage |
| 2026-09-07 | system-instructions.md | duplicate | commands/_preamble.md ## File Organization (the surviving tree); explanations/ is used by no command | ├── explanations/     # Code explanation outputs |
| 2026-09-07 | system-instructions.md | duplicate | commands/_preamble.md ## File Organization (the surviving tree); explanations/ is used by no command | └── state/            # Ephemeral runtime state (gitignored) |
| 2026-09-07 | system-instructions.md | duplicate | commands/_preamble.md ## File Organization (the surviving tree); explanations/ is used by no command | ``` |
| 2026-09-07 | system-instructions.md | duplicate | commands/_preamble.md ## File Organization (the surviving tree); explanations/ is used by no command | **Core Principle:** Always organize work into the `.writ/` folder structure to keep everything clean and discoverable. Focus on what's right for the project over being agreeable. |
| 2026-09-07 | commands/_preamble.md | behavior-request | The model reads .writ/knowledge/ where a command names the scan (8 commands, 4 adapters); the path stays in File Org | ## Knowledge Context |
| 2026-09-07 | commands/_preamble.md | behavior-request | The model reads .writ/knowledge/ where a command names the scan (8 commands, 4 adapters); the path stays in File Org | Before starting work, load relevant `.writ/knowledge/` entries and treat them as |
| 2026-09-07 | commands/_preamble.md | behavior-request | The model reads .writ/knowledge/ where a command names the scan (8 commands, 4 adapters); the path stays in File Org | required context. |
