...
`/create-spec`, `/implement-story`, `/implement-spec`, `/implement-phase`, `/prototype`, `/review`, `/verify-spec`, `/refresh-command`, `/assess-spec`, `/ship`, `/release`, `/plan-product`, `/design`, `/research`, `/refactor`, `/status`, `/new-command`, `/initialize`, `/create-adr`, `/create-issue`, `/edit-spec`, `/migrate`, `/retro`, `/security-audit`, `/explain-code`, `/update-writ`, `/reinstall-writ`, `/uninstall-writ`
