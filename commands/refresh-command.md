...
Zero applied amendments is a valid outcome. The log entry is written regardless, listing each rejected candidate with its reason — no evidence, or eval failed.
